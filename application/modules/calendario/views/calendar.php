...
<input type="hidden" id="hddPopUp" name="hddPopUp" value="<?php echo $infoPopup?$infoPopup[0]['parametro_valor']:""; ?>" />                
                <div class="panel-body">
                	<div class="row">
                		<div class="col-lg-6">
                			<p class="lead"><b>XIX Exposición Nacional de Orquídeas 2022 - Entrada para Servidores(as)</b></p>
                		</div>
                		<div class="col-lg-6">	
					...
					<ul>
						<li><b>XIX Exposición Nacional de Orquídeas 2022</b><br>

							Festejando la vida y biodiversidad<br>
							Es un gusto invitarlos a este importante evento, usted podrá reclamar las boletas/fichas, de sus invitados directamente con el apoyo administrativos de su dependencia o subdirección. Conserve el pantallazo de registro para poder reclamar las boletas/fichas.
						</li>
					</ul>
					</small>
                </div>
